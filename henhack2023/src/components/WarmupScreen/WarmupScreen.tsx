        ...
        <Modal.Body className={'warmup_home_screen_instructions_body'}>
          {
            <>
             <p>
              Greetings, Detective! Since it&apos;s your first day on the job, we have a very
              simple task for you. We&apos;ve been tracking the <strong>Single File Bandits.</strong> They&apos;re
              called that since <strong>they stick together in single file lines.</strong>
            </p>
            <p>
              Luckily we have been able to identify a group of four people getting off a
              bus, and we know that two of the people in the group are members of the bandit gang.
              We need you to find all possible combinations back-to-back bandits so we can continue with the investigation.
            </p>
            </>
          }
        </Modal.Body>
